...
export type Objects = Partial<{
    literals: Record<IriString, readonly string[]>;
    langStrings: Record<string, readonly string[]>;
    namedNodes: Array<IriString | IriString>;
    blankNodes: Array<Predicates | BlankNodeId>;
}>;
export type Predicates = Record<IriString, Objects>;
export type Subject = {
    type: 'Subject';
    url: BlankNodeId | IriString;
